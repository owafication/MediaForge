...
| REQ-063 | V2 advanced | capability-aware advanced projection | PH-22, PH-25, PH-30 | advanced controls and capability services | AC-092, AC-105 | VAL-066, VAL-077 | PH-22 Advanced disclosure source merged; capability-aware/ProcessingPlan consistency remains later/unproven |
...
| REQ-066 | V2 projects | optional session/project persistence | PH-22, PH-28 | task session, project persistence and recovery surfaces | AC-096, AC-097 | VAL-075, VAL-081 | PH-22C merged shell offers project-optional Home/task entry and passed an unsaved-project launch; projectless processing via the existing Advanced route has one retained fixture-backed native pass (see root VERIFICATION.md, PH22-AC096-EVIDENCE-20260924); complete V2 task-first processing remains Unproven. The unchanged `AC-096` project-optional quick-processing criterion has one successful retained native PH-22C Home-to-Advanced fixture, accepted for this literal scope in `BR-20260924-01`; `DEC-039` was not adopted. Full V2 keyboard task completion remains under `AC-103`/`VAL-067` in PH-24. V2 persistence compatibility remains PH-28/unproven |
